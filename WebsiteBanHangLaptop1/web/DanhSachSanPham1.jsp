            ...
            <tr>
                ...
                <td  style="vertical-align: top;" >
                    ...
                    <table width="820px" border="0" cellspacing="0" cellpadding="0" style="margin-left:10px ; vertical-align: top;">
                        ...
                        <tr>
                            <td width="459" height="36" class="timkiem_top_panel">
                                <%if (tongtrang < 1) {
                                    } else {
                                %>
                                Trang  
                            ...
                            <td align="right" class="timkiem_top_panel">Số sản phẩm trên trang </td>
                            <td class="timkiem_top_panel"><form method="post" action="DanhSachSanPham.jsp?HangSanXuat=<%= obj.getMahang()%>&LoaiSanPham=<%=obj.getLoaiSanPham()%>&Trang=1" >
