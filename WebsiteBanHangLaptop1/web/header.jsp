    ...
    <tr>
        <td height="50" colspan="3" id="banner_container"><table width="1000px" height="197" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <td colspan="3"><table width="100%" height="30px">
                            <tr>
                                ...
                                <td align="left" style="padding-left:5px">
                                    <a href="<%
                                        if (Boolean.parseBoolean(session.getAttribute("daDangNhap").toString())) {
                                            out.println("DangKyThanhVien.do?logout=true");
                                        } else {
                                            out.println("DangKyThanhVien.do");
                                        }
                ...
                <tr height="50px">
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td height="50px" width="137"><a href="GioHang.do"><img src="images/CartMenu.png" width="100%" height="50px" /></a></td>
                    <td>&nbsp;</td>
                </tr>
            </table></td>
    </tr>
                    ...
                    <ul>
                        <li><a href="#">Laptop</a>
                            <ul>
                                ...
                                %>
                                <li><a href="DanhSachSanPham.jsp?HangSanXuat=<%= hsx.getMaHang()%>&LoaiSanPham=laptop&Trang=1&SoSanPham=<%=obj.getSosptrang()%>" ><%= hsx.getTenHang()%></a></li>
                                <%}%>
                        ...
                        <li><a href="#" title="Active projects">Linn Kiện</a>
                            <ul>
                                ...
                                %>
                                <li><a href="DanhSachSanPham.jsp?HangSanXuat=<%= hsx.getMaHang()%>&LoaiSanPham=linhkien&Trang=1&SoSanPham=<%= obj.getSosptrang()%>" ><%= hsx.getTenHang()%></a></li>
                                <%}%>
                            </ul>
